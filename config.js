...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'Made By Midhunser' : process.env.ALL_CAPTION,
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://telegra.ph/file/1986d89402b68b4f4aeca.jpg' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'Oggy_ser' : process.env.LOGO_NAME,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ Oggy_ser ⋈ ‒‒‒⊣' : process.env.BOT_NAME,    
